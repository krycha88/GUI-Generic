...
const char* const GPIO_P[] PROGMEM = {GPIO0,  GPIO1,  GPIO2,  GPIO3,  GPIO4,  GPIO5,  GPIO6,  GPIO7,  GPIO8,  GPIO9,
                                      GPIO10, GPIO11, GPIO12, GPIO13, GPIO14, GPIO15, GPIO16, GPIO17, GPIO18, GPIO19,
                                      GPIO20, GPIO21, GPIO22, GPIO23, GPIO24, GPIO25, GPIO26, GPIO27, GPIO28, OFF};
...
const char* const GPIO_P[] PROGMEM = {GPIO0,   GPIO1,   GPIO2,   GPIO3,   GPIO4,   GPIO5,   GPIO6,  GPIO7,  GPIO8,  GPIO9,  GPIO10, S_EMPTY,
                                      S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, GPIO18, GPIO19, GPIO20, GPIO21, OFF};
...
const char* const GPIO_P[] PROGMEM = {GPIO0,   GPIO1,   GPIO2,  GPIO3,   GPIO4,   GPIO5,   GPIO6,   GPIO7,   GPIO8,   GPIO9,  GPIO10,  GPIO11,
                                      GPIO12,  GPIO13,  GPIO14, GPIO15,  GPIO16,  GPIO17,  GPIO18,  GPIO19,  GPIO20,  GPIO21, S_EMPTY, S_EMPTY,
                                      S_EMPTY, S_EMPTY, GPIO26, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, GPIO33, GPIO34,  GPIO35,
                                      GPIO36,  GPIO37,  GPIO38, GPIO39,  GPIO40,  GPIO41,  GPIO42,  GPIO43,  GPIO44,  GPIO45, GPIO46,  OFF};
...
const char* const GPIO_P[] PROGMEM = {GPIO0,   GPIO1,   GPIO2,   GPIO3,   GPIO4,   GPIO5,   GPIO6,   GPIO7,   GPIO8,   GPIO9,
                                      GPIO10,  GPIO11,  GPIO12,  GPIO13,  GPIO14,  GPIO15,  GPIO16,  GPIO17,  GPIO18,  GPIO19,
                                      GPIO20,  GPIO21,  S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY,
                                      S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, S_EMPTY, GPIO35,  GPIO36,  GPIO37,  GPIO38,  GPIO39,
                                      GPIO40,  GPIO41,  GPIO42,  GPIO43,  GPIO44,  GPIO45,  GPIO46,  GPIO47,  GPIO48,  OFF};
...
const char* const ACTION_P[] PROGMEM = {ON,
                                        ...
                                        "Ręczny/Program",
                                        "Przytrzymanie przełącz - Ręczny/Program"};
#else
